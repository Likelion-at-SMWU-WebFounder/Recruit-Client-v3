...
export interface DefaultButtonWhiteProps {
...
const DefaultButtonWhite = ({
  ...
  onClick,
  ...props
}: DefaultButtonWhiteProps) => {
  // 기본 스타일
  const baseClasses =
    'bg-white text-blue lg:hover:bg-blue lg:hover:text-white inline-flex justify-center items-center gap-2.5 overflow-hidden cursor-pointer';
...
export default DefaultButtonWhite;
