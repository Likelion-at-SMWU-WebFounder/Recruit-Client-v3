...
const Menu = ({ mode = 'light', ...props }: MenuProps) => {
  // const navigate = useNavigate(); // TODO: 메뉴 네비게이션 구현 시 사용
...
// 특정 메뉴 접근
const homeMenu = MENU_ITEMS.HOME;
console.log(homeMenu.label); // '홈'
  ...
  return (
    <div className={`${baseClasses} ${responsiveClasses} `} {...props}>
      ...
      {/* Copyright */}
      <div className={copyrightClasses}></div>
    </div>
  );
};
