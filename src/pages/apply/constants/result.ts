  ...
  PASS: {
    ...
    DETAILS: {
      ...
      REPLY_INFO: [
        ...
        { text: '까지 반드시 받으신 문자 번호로 회신 부탁드립니다.', isHighlight: false },
      ],
    },
    NOTES: [
      [
        ...
        { text: '에 착석해 주시길 바랍니다.', isHighlight: false },
      ],
      [
        {
...
export const FINAL_RESULT_TEXT = {
  ...
  PASS: {
    ...
    DESCRIPTION: (track: string, name: string) => [
      ...
      { text: '님은 멋쟁이사자처럼 14기에 ', isHighlight: false },
      ...
      { text: ' 작성으로 확인할 예정이니, ', isHighlight: false },
      { text: '금일 17시', isHighlight: true },
      {
  ...
  FAIL: {
    ...
    MESSAGE: (name: string) => [
      ...
      [
        ...
        { text: `${name}`, isHighlight: true },
        { text: '님의 면접 참석에 대해 다시 한번 감사드립니다.', isHighlight: false },
      ],
