...
// 스타일 상수화
const BADGE_STYLES = {
  base: 'bg-gray-opacity20 text-gray-dark rounded-2xl px-[0.875rem] py-[0.25rem] leading-[160%] font-medium group-hover:text-[#6978B2] group-hover:bg-blue-opacity13',
