...
export const twelfthProjectsData = [
  {
    id: '1200',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/hackathon/voyage.png`],
    title: 'VOYAGE',
    teamMember: '박우현(PM)\n성윤정(FE), 장유빈(FE)\n정지윤(BE), 유채민(BE)',
  ...
  {
    id: '1201',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/hackathon/bbangutbbangood.png`],
    title: '빵긋빵굿',
    teamMember: '김보미(PM)\n강주은(FE), 최현서(FE)\n이효림(BE), 홍상희(BE)',
  ...
  {
    id: '1202',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/hackathon/hancare.png`],
    title: '한케어',
    teamMember: '오시은(PM)\n유동은(FE), 이현정(FE)\n경민서(BE), 서문지(BE)',
  ...
  {
    id: '1203',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/4linethon/prog.png`],
    title: 'P-ROG',
    teamMember: '이현정(FE) 외 5명',
    summary: '평가가 아닌 성장의 기회, 대학생 프로젝트를 위한 피드백 플랫폼',
    description: `문제해결능력과 피드백은 필요충분조건이라는 것을 비롯하여 기획된 서비스입니다.
...
기존의 공유 플랫폼은 대학생 프로젝트를 진행할 때에 성장 과정에 맞지 않는 구조이거나, 직접적인 조언을 얻기 어려운 경우이므로 발전 방향을 찾기 어렵다는 한계점을 가집니다. 이를 극복하고자 P-ROG은 다양한 시각에서의 피드백을 중점으로 받아 프로젝트를 한층 더 성장시키는 과정을 제공하고자 합니다. 따라서 별점, 좋아요, 랭킹 등의 평가적인 요소를 최대한 없애고, 프로젝트에 대한 설명과 함께 고민 부분들도 같이 작성하여 프로젝트를 등록할 수 있습니다. 이용자는 게시된 프로젝트를 보고 피드백 작성을 할 수 있으며,  채택될 경우 포인트를 받을 수 있습니다. 또한 Ai 피드백 정리 보고서 기능도 구현하여, 적립한 포인트로 다량의 피드백을 손쉽게 정리할 수 있습니다.`,
  ...
  {
    id: '1204',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/4linethon/tostar.png`],
    title: '별이에게',
    teamMember: '김보미(PM) 외 5명',
    summary: '펫로스 증후군을 겪는 반려인들을 위한 따뜻한 위로의 공간',
    description: `별이에게는 반려동물의 상실로 인한 아픔을 치유하고 추억을 되새길 수 있도록 돕습니다.
...
게시물 등록 및 친구 추가🐶:사용자가 서로의 게시물을 공유하고 친구를 추가하며 더 깊은 교류를 할 수 있습니다.`,
  ...
  {
    id: '1205',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/4linethon/decemo.png`],
    title: 'DECEMO',
    teamMember: '강주은(FE) 외 5명',
    summary: '한 해의 마지막, 12월 한 달간 추억을 소중하게 기록할 수 있는 회고 서비스',
    description: `DECEMBER + MEMO : 12월 한달간 질문에 답변하며 한 해를 되돌아볼 수 있는 서비스
...
종을 클릭하여 매일매일 달라지는 31가지의 질문에 답변하고 저장할 수 있는 기능을 구현하였고, 진행률을 확인가능하다. 여기에서 작성했던 답변은 1월 1일부터 재열람이 가능하며 2024년 연말의 추억과 다짐을 되돌아볼 수 있는 기능을 기획 및 개발했습니다.`,
  ...
  {
    id: '1206',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/4linethon/joinus.png`],
    title: '조인어스',
    teamMember: '유동은(FE) 외 5명',
    summary: '공유를 통해 환경보호를 실천하고자 하는 서비스',
    description: `지속적으로 증가하는 지구의 온실가스로 나날이 심해지는 기후위기에 관심을 가지고 공유하고자 기획한 서비스입니다.  환경 보호를 위한 작은 행동들을 사진으로 찍어 글과 함께 올리고, 원하는 프레임을 선택하면 나만의 실천 카드를 만들어 공유할 수 있습니다. 만든 실천카드는 월별로 한번에 모아볼 수 있으며, 내 랭킹과 어스 랭킹 1~3위를 볼 수 있으며, 다른 테마를 구매해 적용도 가능합니다.
...
실천 카드를 통해 모인 작은 행동들과 공유를 통해 만들어지는 작은 관심들이 기후와 환경을 향한 큰 관심이 되고, 모인 관심이 세상을 조금 더 푸르게 만들 것입니다.`,
  ...
  {
    id: '1207',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/4linethon/2gather.png`],
    title: '2GATHER',
    teamMember: '최현서(FE) 외 5명',
    summary: 'AI 기반 타임라인 마케팅 전략 제안 플랫폼',
    description: `대부분의 대학생, 사회초년생들은 제한된 자원과 네트워크의 한계로 인해 팀원을 찾는 것에 어려움을 겪고 있음. 기존의 제한적인 홍보 방법 등을 볼 때 능력있는 사람들이 기회를 찾고 네트워크를 넓히는 데 한계가 있다고 느껴 기획한 서비스
...
매년 새로운 사용자를 유입하고, 졸업 후 3년, 또는 창업 . 후5년이 경과한 전문가들은 순환 구조에 따라 플랫폼을 떠나게 하여 신선한 크리에이터가 지속적으로 유입되는 시스템을 유지하도록 했다. AIDA 모델을 기반으로 인공지능을 학습시켜 한정된 자금 내에서 최대 효과를 내는 홍보 전략 및 마케팅 플랜을 짤 수 있다. 또한 예산에 맞는 크리에이터 추천이나 직관적인 결과를 제시해준다는 장점도 있다.`,
  ...
  {
    id: '1208',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/4linethon/planpal.png`],
    title: '플랜팔',
    teamMember: '박우현(PM)\n경민서(BE) 외 4명',
...
각자의 바쁜 일정을 한눈에 파악하고 가용시간을 기반으로 최적의 약속시간을 자동 추천하여협업과 소통의 효율성을 극대화하는 서비스로 단순한 일정관리 도구를 넘어, 서로의 계획을 함께 실현하는 파트너로 자리 잡을 수 있도록 설계되었습니다.`,
  ...
  {
    id: '1209',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/4linethon/nugu.png`],
    title: '누구 (NUGU)',
    teamMember: '유채민(BE), 정지윤(BE) 외 4명',
    summary: '함께 만들어가는 트렌디한 자기소개 서비스',
    description: `“나보다 나를 더 잘 아는 친구가 나를 대신 소개한다면?”
...
다함께 즐기는, 누구 테스트(소유자와 접속자가 서로를  더 잘 알 수 있는 퀴즈)`,
  ...
  {
    id: '1210',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/4linethon/line4thonservice.png`],
    title: '4호선톤 사이트',
    teamMember: '홍상희(BE) 외 5명',
    summary: '멋쟁이들을 위한 4호선톤 축제',
    description: `해커톤을 참가해도 서비스를 홍보하기에 어려움을 느꼈거나, 서비스 배포 이후 실제 사용자 리뷰를 받을 수 없어서 아쉬웠던 점을 극복하고자 기획한 서비스이자 4호선톤 참가자들이 자유롭게 서비스를 업로드하고, 평가할 수 있는 웹 플랫폼
  ...
  {
    id: '1211',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/4linethon/moatravel.png`],
    title: 'MOA(모아)',
    teamMember: '성윤정(FE)\n서문지(BE) 외 3명',
...
사용자의 여행 타입을 진단하여, 개인의 여행 스타일에 맞는 여행 유형을 추천하는 기능을 제공합니다. 각 화면을 통해 사용자는 퀴즈 형식으로 여행 취향과 스타일을 탐색할 수 있으며, 결과에 따라 자신의 여행 성향을 시각적으로 확인할 수 있습니다. 또한 검색 및 필터링 기능이나 여행 정보 게시물을 모아 볼 수 있는 커뮤니티 기능도 구현하였습니다.`,
  ...
  {
    id: '1212',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/4linethon/pyeonshulleng.png`],
    title: '편슐랭',
    teamMember: '이효림(BE) 외 5명',
    summary: '편의점 꿀조합 모음 서비스',
    description: `사용자들이 다양한 편의점 상품을 조합하여 자신만의 꿀 조합을 만들고, 공유할 수 있는 웹 애플리케이션
...
높아지는 물가에 편의점 음식으로 식사를 해결하는 사람이 많아지고, 그에 따라 여러 맛있는 조합도 인스타와 페이스북 등 여러 SNS에 퍼지고 있음.하지만 그 레시피들을 모아서 볼 수 있는 어플이나 사이트가 없고 자신의 레시피를 추천하고 공유하고자 하는 사람들의 커뮤니티 어플도 존재하지 않음.따라서 편의점에서 자신만의 맛있는 조합을 만들고, 그 아이디어를 공유하고 또 다른 사용자의 레시피도 함께 보면서 편의점에서 간단히 식사를 해결하는 것만이 아닌 편의점 식사에서의 즐거움을 제공하고자 하는데 목적을 둠`,
  ...
  {
    id: '1213',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/4linethon/timi.png`],
    title: 'Timi',
    teamMember: '장유빈(FE) 외 4명',
    summary: '가장 간편한 그룹 시간 조율 서비스',
    description: `모바일 환경 최적화 - 공유가 편리한 그룹 시간 관리 서비스
...
최종 확정 시간 표시 - 그룹의 최종 확정 시간과 만남 장소를 확정지어 팀원 모두 확인 가능`,
  ...
  {
    id: '1214',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/finalproject/yourstory.png`],
    title: '당신의 이야기',
    teamMember: '오시은(PM)\n강주은(FE), 성윤정(FE)\n이효림(BE), 정지윤(BE)',
...
센터(사회복지사/홀몸 어르신)과 지자체(도서관/출판사), 그리고 개인(봉사자/웹 방문자)가 상호작용하며 20~30대 청년층과 60~80대의 어르신과의 만남을 통한 세대 간 연결을가능하게 하는 사회적 가치 창출 공공 웹서비스입니다.`,
  ...
  {
    id: '1215',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/finalproject/imfine.png`],
    title: '아임파인',
    teamMember: '박우현(PM)\n최현서(FE), 이현정(FE)\n경민서(BE), 유채민(BE)',
...
지속적이고 쉽게 접근 가능한 어린이들을 위한 금융교육을 제공하기 위해 전 날의 경제 뉴스를 요약하여 제공하고, 해당 내용 기반 퀴즈 기능을 구현하였습니다.`,
  ...
  {
    id: '1216',
    images: [`${TWELFTH_PROJECT_IMAGE_PATH}/finalproject/erumi.png`],
    title: '이루미',
    teamMember: '김보미(PM)\n유동은(FE), 장유빈(FE)\n서문지(BE), 홍상희(BE)',
