...
export const ninthProjectsData = [
  ...
  },
  {
    ...
    description: `- 자취생 혹은 1인가구의 경우 집에서 직접 요리를 해먹을 때, 가지고 있는 재료로 할 수 있는 요리 레시피를 찾아봅니다. 그러나 이 재료 조합으로 할 수 있는 요리 자체를 생각해내는 것도 어려울 뿐더러, 시중에 나와있는 레시피는 대부분 우리에게 없는 재료까지 포함하는 경우가 많습니다. 따라서 저희 인덕션팀은 사용자가 가지고 있는 음식 재료를 선택하면 해당 재료만으로 만들 수 있는 음식과 해당 재료를 포함한 음식 및 레시피를 보여주는 서비스를 기획하였습니다.
...
`,
  ...
  },
  {
    ...
    description: `개발직군 채용공고를 확인하고 포트폴리오를 관리할 수 있는 서비스 RoadMap입니다. 
