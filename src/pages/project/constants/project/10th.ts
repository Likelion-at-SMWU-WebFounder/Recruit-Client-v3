...
export const tenthProjectsData = [
  {
    ...
    teamMember: '양지원(PM) 김수민(FE) 양은수(FE) 조은비(BE) 최예진(BE)',
  ...
  },
  {
    ...
    title: 'rememB',
    teamMember: '고두영(FE) 나유진(FE) 박소윤(BE) 이수민(BE)',
    summary: '한 번 뿐인 생일을 더욱 특별하게, 마음을 전하는 rememB',
    description: `내 생일파티에 초대할게! 내 파티룸을 꾸며줘💖
...
마음을 전하는 rememBirthday 🍰🎂`,
    googleDriveUrl: 'https://drive.google.com/file/d/1do-fRYFBXBcBmkhp4F0DJPef047y1s6f/view?usp=sharing',
    gitOrgUrl: null,
    gitBeUrl: 'https://github.com/Likelion-at-SMWU-10th/rememB-Server',
    gitFeUrl: 'https://github.com/Likelion-at-SMWU-10th/rememB-Client',
    no: '10기',
    category: '중앙해커톤',
    techStack: 'Django, React(JavaScript)',
    award: null,
  },
  {
    ...
    title: 'Otr.',
    teamMember: '김희원(PM) 배지윤(FE) 소희수(FE) 김지수(BE) 임아현(BE)',
