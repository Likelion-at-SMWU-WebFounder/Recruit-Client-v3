...
export const eleventhProjectsData = [
  {
    ...
    googleDriveUrl: 'https://drive.google.com/file/d/1eN87dwYzK3rDrvE4HJbXMvNINs7TyhSt/view?usp=sharing',
    gitOrgUrl: null,
  ...
  },
  {
    ...
    googleDriveUrl: 'https://drive.google.com/file/d/1mved5wqRSKIu-DNp76A4colDqqeue52o/view?usp=sharing',
    gitOrgUrl: null,
  ...
  },
  {
    ...
    googleDriveUrl: 'https://drive.google.com/file/d/1sjHZyZGayUTJyrpaueF-D06Fb7JF7VdG/view?usp=sharing',
    gitOrgUrl: null,
  ...
  },
  {
    ...
    description: `우리가 ‘빠더너스'라는 브랜드의 인하우스 서비스 기획팀이 된다면?
...
오프라인 모임 시 게임 툴 제공입니다.`,
    googleDriveUrl: 'https://drive.google.com/file/d/14SARSOnEt43esqkatEWruxNWOiaX8XES/view?usp=share_link',
    gitOrgUrl: 'https://github.com/BDNS-AWARDS',
    gitBeUrl: null,
  ...
  },
  {
    ...
    summary: '한 해 회고 서비스',
    description: `한해를 마무리하는 열쇠, Farewell  2023
...
타인이 나의 회고록 또한 작성해줄 수 있는 기능 구현`,
    googleDriveUrl: 'https://drive.google.com/file/d/1fX-choQyXCq_GL9RGOtD8J-nWtjj5qIm/view?usp=share_link',
    gitOrgUrl: 'https://github.com/FAREWELL2023',
    gitBeUrl: null,
  ...
  },
  {
    ...
    description: `1. 나만의 포토꾸러미 URL 다른 인증 절차 없이 쉽고 간단한 로그인으로 나만의 URL 생성
...
사진을 검사하여 클린한 포토꾸러미 사용 가능`,
    googleDriveUrl: 'https://drive.google.com/file/d/1yrvWHVGUTgXjOQyUNdOIG0CNCrgJ7TYd/view?usp=share_link',
    gitOrgUrl: 'https://github.com/Kureomi',
  ...
  },
  {
    ...
    description: `🤖 짱구 등장인물로 보는 나의 개발 유형!
...
제공된 오픈채팅 링크로 연결해 적극적으로 협업 제안 해보기`,
    googleDriveUrl: 'https://drive.google.com/file/d/1D7luOGAXKu3nVFsZsHnku0ObyEb03og-/view?usp=share_link',
    gitOrgUrl: null,
    gitBeUrl: null,
    gitFeUrl: null,
    no: '11기',
...
결과와 관련된 다양한 매거진을 볼 수 있어요. 어디가서 어떻게 사야할지, 어떻게 마셔야할지, 무엇이랑 마셔야할지 고민할 필요 없어요!!`,
    googleDriveUrl: 'https://drive.google.com/file/d/1-l3SsM3uqtPEzDqU2G7x-E0shq80Ei7U/view?usp=share_link',
    gitOrgUrl: 'https://github.com/WhiskeyLikey',
    gitBeUrl: null,
...
소감 남기기 (자유롭게 스터디 소감 작성, 공감 기능을 통한 유대감 형성)`,
    googleDriveUrl: null,
    gitOrgUrl: 'https://github.com/Songyee-Challenge',
    gitBeUrl: null,
    gitFeUrl: null,
    no: '11기',
    category: '파이널프로젝트',
