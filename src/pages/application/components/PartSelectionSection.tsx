        ...
        <div className="flex w-full flex-col gap-[1rem] md:w-[24.75rem] md:gap-[1.375rem] lg:w-[40.3125rem]">
          <div className="flex w-full items-end justify-between">
            ...
            <a
              ...
              className="cursor-pointer text-[0.8125rem] font-medium break-keep text-[rgba(27,38,52,0.65)] underline md:text-[1rem] lg:text-[1.25rem]">
          ...
          <div className="flex w-full flex-col gap-[0.75rem]">
            ...
            {programmersCompleted ? (
              <div className="flex h-[2.8rem] w-full items-center gap-[0.75rem] rounded-[0.9375rem] border-2 border-[#F0F5FA] bg-[#F0F5FA] p-[0.625rem_0.5625rem_0.625rem_0.5625rem] shadow-[1px_1px_6.4px_0_rgba(27,38,52,0.10)] md:h-[3.625rem] lg:h-[4.1875rem]">
                <img
                  src={ClipIcon}
                  alt="clip"
                  className="h-[1.375rem] w-[1.375rem] md:h-[1.875rem] md:w-[1.875rem] lg:h-[2.3125rem] lg:w-[2.3125rem]"
                />
              ...
              <button
                ...
                className="group flex h-[2.8rem] w-full cursor-pointer items-center justify-center rounded-[1rem] border-2 border-[var(--color-blue)] bg-[var(--color-white)] shadow-[1px_1px_8.4px_0_rgba(27,38,52,0.10)] transition-all hover:bg-[var(--color-blue)] md:h-[3.625rem] lg:h-[4.1875rem]">
