...
제출 완료 후 랜딩되는 페이지를 시간이 보이는 전체 화면으로 캡쳐해 두시면 추후 증빙 자료로 활용될 수 있습니다.`,
  ...
  eventParticipation: {
    ...
    content: `주식회사 멋쟁이사자처럼은 「개인정보보호법」 등 관련 법령을 준수하여 「멋쟁이사자처럼 대학 13기」 참가자의 개인정보를 보호합니다.

가. 수집·이용 목적: 참가신청 본인확인, 프로그램 진행 안내, 마케팅 활용 등
나. 수집 항목: 성명, 연락처, 이메일, 학번, 학과 등
다. 보유·이용 기간: 목적 달성 시 파기 (단, 참여 인정 문서 발급을 위해 5년간 보존)
라. 거부 권리: 동의를 거부할 수 있으나, 미동의 시 프로그램 참가가 불가능합니다.`,
