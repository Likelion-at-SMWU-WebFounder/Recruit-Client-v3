...
const CURRICULUM_STYLES = {
  ...
  row: {
    base: 'grid grid-cols-[1fr_2fr_3fr] justify-between items-center border-b border-gray-100 last:border-0 whitespace-pre-line',
    desktop: 'lg:w-[56.875rem]  lg:py-[2.19rem]',
    tablet: 'md:w-[36.35281rem]  md:py-[1.94rem]',
  ...
  tool: {
    base: 'text-navyblack text-center',
    desktop: 'lg:bd28 ',
    tablet: 'md:bd17 ',
    mobile: 'bd13 ',
  },
